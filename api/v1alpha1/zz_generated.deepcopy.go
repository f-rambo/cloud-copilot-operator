...
func (in *Cluster) DeepCopyInto(out *Cluster) {
	*out = *in
	...
	if in.IngressControllerRules != nil {
		in, out := &in.IngressControllerRules, &out.IngressControllerRules
		*out = make([]*IngressControllerRule, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(IngressControllerRule)
				**out = **in
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IngressControllerRule) DeepCopyInto(out *IngressControllerRule) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IngressControllerRule.
func (in *IngressControllerRule) DeepCopy() *IngressControllerRule {
	if in == nil {
		return nil
	}
	out := new(IngressControllerRule)
